...
export default [
  ...
  }),
  {
    rules: {
      ...
      '@stylistic/quotes': ['error', 'single', {avoidEscape: true}], // シングルクォートを使用
      ...
      'object-curly-newline': 'off', // @stylistic/object-curly-newlineルールを使用
      '@stylistic/object-curly-newline': [
        'error',
        {
          ObjectExpression: {
            multiline: true,
            minProperties: 2, // プロパティが2つ以上で改行を強制
          },
          ObjectPattern: {
            multiline: true,
            minProperties: 2,
